...
class ApolloEngineLauncher extends events_1.EventEmitter {
    ...
    start(options = {}) {
        ...
        const spawnChild = () => {
            ...
            const args = ['-listening-reporter-fd=3'];
            ...
            const child = child_process_1.spawn(this.binary, args, { stdio, env });
            this.child = child;
